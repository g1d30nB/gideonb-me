...
O.append(F(fig("Case one &middot; leading at a distance",A,"fill","Two columns, and the line between them was the job","Stepping out of the daily craft was a choice. The split below is what it meant in practice.",
...
O.append(F(fig("Case one &middot; growing people",A,"fill","Every one of the 40+ hired by me, and most of them stayed","Progression before scale, listening that closed the loop, and a workforce shaped for the long term.",
  ...
  f'<p class="lbl" style="font-size:10px;margin:var(--s5) 0 var(--s3);">Same headcount, a different team</p>{bar("Roughly half permanent, when the shift began",50,"oklch(0.55 0.075 62)")}{bar("Two thirds permanent, at the end",67,"oklch(0.48 0.085 62)")}',
...
O.append(F(fig("Case one &middot; how it was run",A,"fill","An internal consultancy, not a service desk","Six disciplines under one roof, four ways to buy them, and a management office at the centre of embedded teams.",
...
O.append(blk("What I did instead",A,"fill",P(role2[1:]),pt=34)); O.append(blk("How",A,"fill",deflist(c2["approach"])))
...
O.append(F(fig("Case two &middot; the public proof",A,"fill","What customers actually left behind","The rating is the headline. The composition underneath it is the story.",
...
O.append(F(fig("Case three &middot; the failure that taught me most",A,"fill","Nothing was broken. The prompt had grown six times.","Quality started degrading around the fourth session per user. Context had simply accumulated until the model was drowning in its own history.",
  ...
  foot="The fix was architectural. Hard character budgets, enforced however many sessions a user has had."),pt=40))
