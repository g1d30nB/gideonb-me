...
- **3b question: does the takeaway line survive?** The opener heading and the diagram takeaway both state a section's argument. Where both exist, the takeaway is the one that repeats. Decide in 3b whether the takeaway becomes a caption of fact only, or goes. (Evidence from 3a: of the breaks of the title rule found in takeaways, three were caused by an opener heading and one by a stat band. After the cuts, nine distinct takeaway lines remain across the seventeen components and the templates; eight are placed (evmeasure is not), and all eight sit in a section introduced by an opener.)
